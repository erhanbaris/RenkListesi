...
extension Color {
    ...
    func colorRed() -> CGFloat {
        return rgba().r
    }
    
    func colorGreen() -> CGFloat {
        return rgba().g
    }
    
    func colorBlue() -> CGFloat {
        return rgba().b
    }
    
    func colorAlpha() -> CGFloat {
        return rgba().a
    }
    
    func colorHue() -> CGFloat {
        return hsba().h
    }
    
    func colorSaturation() -> CGFloat {
        return hsba().s
    }
    
    func colorBrightness() -> CGFloat {
        return hsba().b
    }
    ...
    func blackOrWhiteContrastingColor() -> Color {
        ...
        return value > 0.5 ? Color.whiteColor() : Color.blackColor()
    }
    ...
    func colorScheme(type: ColorScheme) -> [Color] {
        ...
        default:
            return Color.complementary(self.hsba())
        }
    }
    ...
    private class func complementary(hsbaT: (h: CGFloat, s: CGFloat, b: CGFloat, a: CGFloat)) -> [Color] {
